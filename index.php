...
<?php
    ...
    $todolist = $app->getTodos();
?>
<div class="bg-white w-1/3 mx-auto shadow-xl rounded-lg py-3 mt-24 x">
    <div class="p-2 flex justify-center">
        <svg class="w-8 mr-2 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
        </svg>
        <h3 class="text-center text-xl text-gray-600 font-bold leading-8"><a class="focus:outline-none" href="/">Basit Todo Uygulaması</a></h3>
    </div>
    <div class="p-2">
        ...
        <div class="text-center text-gray-400 text-xs font-semibold">
            <ul>
                ...
                $id = 1;
                if (empty($todolist)){
                    echo "<p> Yapılacaklar Listeniz Tertemiz! </p>";
                }else{
                    foreach($todolist as $v){
                        echo '
                              <li class="mt-4">
                                  <div class="grid grid-cols-2  border-b-2 py-2 mx-32">
                                      <div class="col-span-1">
                                          <div class="flex h-full items-center">
                                              <div class="inline-block capitalize break-word">
                                                  <p> '.$v.' </p>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="col-span-1">
                                          <form class="m-0" action="/index.php" style="display:inline-block" >
                                          <input type="hidden" value="delete" name="delete" />                      
                                          <input type="hidden" value="'.($count++).'" name="id" />
                                          <input type="hidden" value="'. $v .'" name="value" />
                                              <div class="flex">
                                                  <input class="px-2 ml-4 border-2 text-green-600 bg-white border-green-600 focus:outline-none cursor-pointer rounded-md hover:bg-green-600 hover:text-white transitions duration-300" type="submit" value="Yapıldı" />
                                                  <a href="update.php?id='. ($id++) .'&value='. $v .'">
                                                  <svg class="w-8 ml-2 text-blue-600 focus:outline-none hover:bg-blue-600 hover:text-white transitions duration-300 rounded-md" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
